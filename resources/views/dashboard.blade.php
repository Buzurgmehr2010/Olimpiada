...
<style>
    ...
    .dash-chart-bars { display: flex; flex-direction: column; gap: 14px; }
    .dash-bar-item { display: flex; align-items: center; gap: 12px; }
    .dash-bar-label { width: 110px; font-size: 0.88rem; font-weight: 600; color: var(--text-primary); flex-shrink: 0; }
    .dash-bar-track { flex: 1; height: 34px; background: var(--bg-hover); border-radius: 10px; overflow: hidden; }
    .dash-bar-fill { height: 100%; border-radius: 10px; display: flex; align-items: center; justify-content: flex-end; padding-right: 12px; transition: width 1.2s ease; min-width: 44px; }
    .dash-bar-fill span { color: white; font-weight: 700; font-size: 0.82rem; }
